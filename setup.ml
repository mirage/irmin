...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6ea69c9c408fb265d8ada2c61debf818) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the MirageOS libraries";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Flag
                 ({
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Irmin_link"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "irmin";
                      lib_findlib_name = Some "link";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "irmin-chunck";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Irmin_chunck"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "irmin";
                      lib_findlib_name = Some "chunck";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "irmin-mirage";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "irmin-http";
                           FindlibPackage ("cohttp.lwt", None);
                           FindlibPackage ("git.mirage", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("nocrypto", None);
                           InternalLibrary "irmin-chunck";
                           InternalLibrary "irmin-krypto";
                           InternalLibrary "irmin-link"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "link_chunck.ml"});
               Executable
                 ({
                     cs_name = "test_link_chunck_krypto";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "link_chunck_krypto.ml"
                   });
               Executable
                 ({
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "deploy.ml"});
               Executable
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "Ôù@`§ñË<\127.Èsò(\142\136";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
