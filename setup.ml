...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9fb35fbb0932b606c94dd7a4acccc96e) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Irmin_git"; "Irmin_memory"];
                      lib_pack = false;
                      lib_internal_modules = [];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("irmin.server", None);
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "âï\127=\030û\011\127i·k\158>;d\001";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
