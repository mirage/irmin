...
(* OASIS_START *)
(* DO NOT EDIT (digest: 124b2e5cfa143d163f071977dcf71e75) *)
(*
...
let setup_t =
  {
       ...
       [
          ("irmin",
            OCamlbuildDocPlugin.doc_build
              {OCamlbuildDocPlugin.extra_args = []; run_path = "lib/core"});
          ("backend",
            OCamlbuildDocPlugin.doc_build
              {OCamlbuildDocPlugin.extra_args = []; run_path = "lib/backend"})
       ];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the Xen library";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the Git backend";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("git.memory", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["IrminCRUD"; "IrminMemory"; "IrminGit"];
                      lib_pack = false;
                      lib_internal_modules = [];
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "backend";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "unix", OASISExpr.EFlag "git"),
                             true)
                        ];
                      bs_install =
                        [
                   ...
                   {
                      lib_modules = ["IrminHTTP"; "IrminHTTPStatic"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "irmin";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "irminMain.ml"});
               Executable
                 ({
                     cs_name = "test_irmin";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "Ð\014\127baî\018\020\025´\140e6\012ñ\157";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
