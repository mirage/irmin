...
(* OASIS_START *)
(* DO NOT EDIT (digest: 702f827d168d4aceb2c2abffa2144fab) *)
(*
...
let setup_t =
  {
     ...
     doc =
       [
          ("irminsule", OCamlbuildDocPlugin.doc_build "lib/core");
          ("backend", OCamlbuildDocPlugin.doc_build "lib/backend")
       ];
     ...
     clean_doc =
       [
          ("irminsule", OCamlbuildDocPlugin.doc_clean "lib/core");
          ("backend", OCamlbuildDocPlugin.doc_clean "lib/backend")
       ];
     distclean = [];
     distclean_test =
       [
            ...
            [
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "irminsule";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["IrminCRUD"; "IrminMemory"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "irminsule";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install = [(OASISExpr.EBool true, true)];
                      doc_install_dir = "$docdir";
                      doc_title = "Irminsule backends docs";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "0\005`ã¿\023\007b®\024'LìUjµ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
