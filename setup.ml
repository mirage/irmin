...
(* OASIS_START *)
(* DO NOT EDIT (digest: d1ca54c0c51736cc1e4500aa796476b2) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "index_chunck.ml"});
               Executable
                 ({
                     cs_name = "test_index_chunck_krypto";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "index_chunck_krypto.ml"
                   });
               Executable
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\176\215\128l\190l,\220\229\161\144\205I\014[\204";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
