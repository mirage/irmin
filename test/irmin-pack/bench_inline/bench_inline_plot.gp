...
# Usage: gnuplot -e "datafile='path/to/data.dat'; outfile='output.png'" bench_inline_plot.gp

if (!exists("datafile")) datafile = 'bench_inline_plot.dat'
if (!exists("outfile")) outfile = 'bench_inline_comparison.png'
...
plot datafile using 2:xtic(1) title 'No Inlining' ls 1, \
