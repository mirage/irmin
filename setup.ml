...
(* OASIS_START *)
(* DO NOT EDIT (digest: b327661e31977b855f9317df8d0b3fc9) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["IrminCRUD"; "IrminMemory"; "IrminGit"; "IrminFS"];
                      lib_pack = false;
                      lib_internal_modules = [];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "irmin-backend";
                           InternalLibrary "irmin-server";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "examples/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "irmin-unix"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\141\004»זכ\158j!\005\1274צ\0164\029/";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
