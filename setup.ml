...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3fb5dcfbea3a98d1f78e58788022a2d7) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_irmin", ["-q"]))];
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the http libraries";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the git libraries";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Flag
                 ({
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "lib/mem";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "irmin"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules = ["Irmin_mem"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "irmin";
                      lib_findlib_name = Some "mem";
                      lib_findlib_containers = []
                   });
               Library
                 ({
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Irmin_http"; "Irmin_http_server"];
                      lib_pack = false;
                      lib_internal_modules = ["Irmin_http_static"];
                      lib_findlib_parent = Some "irmin";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "irmin-git";
                           InternalLibrary "irmin-fs";
                           InternalLibrary "irmin-http";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Irmin_index"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "irmin";
                      lib_findlib_name = Some "index";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "irmin-bucheron";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Irmin_bucheron"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "irmin";
                      lib_findlib_name = Some "bucheron";
                      lib_findlib_containers = []
                   });
               Doc
                 ({
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "krypto.ml"});
               Executable
                 ({
                     cs_name = "test_index_bucheron_krypto";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "irmin-mem";
                           InternalLibrary "irmin-index";
                           InternalLibrary "irmin-bucheron"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "index_bucheron_krypto.ml"
                   });
               Executable
                 ({
                     cs_name = "test_git_store";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "git_store.ml"});
               Executable
                 ({
                     cs_name = "test_custom_merge";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "custom_merge.ml"});
               Executable
                 ({
                     cs_name = "test_views";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "views.ml"});
               Executable
                 ({
                     cs_name = "test_contatcs";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "contacts.ml"});
               Executable
                 ({
                     cs_name = "test_intrusion";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "intrusion.ml"});
               Executable
                 ({
                     cs_name = "test_process";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "process.ml"});
               Executable
                 ({
                     cs_name = "test_sync";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "sync.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\253\"H\221\t\165\154\213\018\244\024i\129\226*I";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
