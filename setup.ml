...
(* OASIS_START *)
(* DO NOT EDIT (digest: d4e790152161debdeca9271209cc5aef) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Krypto_cipher"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "irmin_krypto";
                      lib_findlib_name = Some "krypto_cipher";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Krypto_km"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "irmin_krypto";
                      lib_findlib_name = Some "krypto_km";
                      lib_findlib_containers = []
                   });
               Doc
                 ({
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "krypto_git.ml"});
               Executable
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "ŒKªŒue\\æ\007\151\149ªh›K4";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
