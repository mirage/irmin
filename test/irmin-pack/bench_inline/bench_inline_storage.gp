...
# Usage: gnuplot -e "datafile='path/to/data.dat'; outfile='output.png'" bench_inline_storage.gp

if (!exists("datafile")) datafile = datafile
if (!exists("outfile")) outfile = 'bench_inline_storage.png'
...
plot datafile using ($3/1024):xtic(2) title 'No Inlining' lc rgb '#4472C4', \
...
plot datafile using 1:5:(($5<0)?0x70AD47:0xC00000):xtic(2) with boxes lc rgb variable title 'Storage Change', \
